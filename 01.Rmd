...
-  This will download a .zip file, named `yourName_WordGuessProject.zip` with a folder of all the files you need for this project.
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  input.addEventListener("input", function () {
    ...
    let fname = name ? name + "_WordGuessProject" : "projectFiles";
