...
```{=html}
<div style="padding:15px; border-left:5px solid #ccc; margin:20px 0;">
<details open>
...
window.addEventListener("load", function () {
  ...
  window.check = async function() {
    ...
    try {
      const res = await fetch("https://us-central1-mineral-pride-474706-c6.cloudfunctions.net/run_student_code", {
        method: "POST",
